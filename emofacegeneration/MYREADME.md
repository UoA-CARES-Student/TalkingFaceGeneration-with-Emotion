...
python wav2lip_train_Takahiro.py --data_root / --checkpoint_dir checkpoint_3 --syncnet_checkpoint_path discriminator/lipsync_expert.pth
...
python hq_wav2lip_train.py --data_root / --checkpoint_dir checkpoints/deeper_v2_jul_9 --syncnet_checkpoint_path discriminator/lipsync_expert.pth
```
