...
from models import Wav2Lip, Wav2Lip_disc_qual, emotion
import audio
    ...
    while global_epoch < nepochs:
        ...
        for step, (x, indiv_mels, mel, gt) in prog_bar:
            ...
            loss = hparams.syncnet_wt * sync_loss + hparams.disc_wt * perceptual_loss + \
                                    (1. - hparams.syncnet_wt - hparams.disc_wt - hparams.emo_wt) * l1loss + \
            ...
            metrics = { 
                        ...
                        "train/percep_loss": perceptual_loss,
         ...
         ## Validate Epoch
            if global_step % hparams.eval_interval == 0:
                with torch.no_grad():
                    ...
                    if 80 < global_epoch < 120:
                        hparams.set_hparam('emo_wt', 0.1)
                    if 120 < global_epoch < 150:
                        hparams.set_hparam('emo_wt', 0.15)
                    if global_epoch > 150:
                        hparams.set_hparam('emo_wt', 0.2)


            prog_bar.set_description('L1: {}, Sync: {}, Percep: {} | Fake: {}, Real: {} | emo_loss: {}'.format(running_l1_loss / (step + 1),
...
if __name__ == "__main__":
    ...
    """
    wandb.init(
        project="wav2lip_CREM_HAP_increase_norm_Disc",
