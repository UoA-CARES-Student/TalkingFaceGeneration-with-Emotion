...
parser.add_argument("-is", "--speech-file", type=str, help="input speech file", default='data/speech_samples/speech01.wav')
parser.add_argument("-im", "--img-file", type=str, help="input image file", default='data/image_samples/resize_Anne.jpg')
...
parser.add_argument("-o", "--out-fold", type=str, help="output folder", default='emo')
parser.add_argument("--gpu", type=str, help="GPU index", default="1")
args = parser.parse_args()

file_path1 = 'get_frames.py'
file_path2 = 'inference_codeformer.py'
file_path3 = 'paste_back.py'
file_path4 = 'img2vid.py'
...
def execute_python_file(file_path1):
    try:
      completed_process = subprocess.run(['python', file_path1], capture_output=True, text=True)
      if completed_process.returncode == 0:
         print("Execution successful.")
         print("Output:")
         print(completed_process.stdout)
      else:
         print(f"Error: Failed to execute '{file_path1}'.")
         print("Error output:")
...
time.sleep(3)
execute_python_file(file_path3)
execute_python_file(file_path4)
